...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate: AggregateRoot
    {
        ...
        public void EditComment(Guid commentId, string comment, string username)
        {
            ...
            {
                throw new InvalidOperationException("You are not allow to  edit a comment made by another user!");
            }
        ...
        public void RemoveComment(Guid commentId, string username)
        {
            ...
            if(!_comments[commentId].Item2.Equals(username, StringComparison.CurrentCultureIgnoreCase))
            {
                throw new InvalidOperationException("You are not allow to  remove a comment made by another user!");
            }
        ...
        public void DeletePost(string username)
        {
            if(!_active)
            {
                throw new InvalidOperationException("The post has aready been removed!");
            }

            if(!_author.Equals(username, StringComparison.CurrentCultureIgnoreCase))
            {
                throw new InvalidOperationException("You are not allow to delete a post made by another user!");
            }
